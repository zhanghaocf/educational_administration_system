...
<html>
	...
	<body>
		<section>
			<label for="name" class="label1">学生姓名:<input id="name" type="text"></label><br/><br/>
			<label for="pass" class="label2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;密码:<input id="pass" type="password"></label><br/><br/>
			<label for="" class="label3">学生专业:<select><option value="计算机">计算机</option><option value="法学">法学</option></select></label><br/><br/>
			<label for="" class="label4">入学时间:<select><option value="13">2013</option><option value="14">2014</option><option value="15">2015</option><option value="16">2016</option></select></label><br/><br/>
